...
namespace vhrm.FrameWork.DataAccess
{
    public class EmployeeMasterAccess
    {
        ...
        public DataTable InsertEmployee(EmployeeMaster employeeMaster)
        {
            ...
            //param[30] = new OracleParameter("T_TABLE", OracleType.Cursor) { Direction = ParameterDirection.Output };
        ...
        public static DataTable getEmpBasic()
        {
            ...
            _param[0] = new OracleParameter("T_TABLE", OracleType.Cursor) { Direction = ParameterDirection.Output };
